...
| Serverless DB and object storage | Operation counts and stored GB-month | W7S can provision per-app DB, key-value, and object storage bindings; database usage is included in the same usage model. |
