...
The estimate intentionally does not subtract included monthly usage, free-tier allowances, or account-level plan floors. It estimates operating cost from the selected traffic shape, adds W7S overhead, then applies a 50% gross margin.
